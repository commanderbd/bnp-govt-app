    ...
    <div style={{ borderTop: `1px solid ${T.border}`, marginTop: 16, paddingTop: 16 }}>
      ...
      {comments.map((c, i) => (
        <div key={i} style={{ display: "flex", gap: 10, marginBottom: 14 }}>
          <div style={{ width: 34, height: 34, borderRadius: "50%", background: `hsl(${(c.user_name || "U").charCodeAt(0) * 13 % 360}, 50%, 40%)`, display: "flex", alignItems: "center", justifyContent: "center", fontSize: 14, color: "#fff", flexShrink: 0, fontWeight: "bold" }}>
